...
from src.training.kai0_profiles import Kai0TrainProfile
...
def _build_env(
    ...
    *,
    ...
    if ffmpeg_home:
        ...
        env["LD_LIBRARY_PATH"] = _prepend_path(f"{ffmpeg_home}/lib", env.get("LD_LIBRARY_PATH", ""))
    conda_lib_path = env.get("CONDA_LIB_PATH")
    if conda_lib_path:
        env["LD_LIBRARY_PATH"] = _prepend_path(conda_lib_path, env.get("LD_LIBRARY_PATH", ""))
